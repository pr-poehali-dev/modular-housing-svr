        ...
        <div className="container relative grid lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <p className="mt-8 text-muted-foreground leading-relaxed">
              SVR GROUP — производственная компания, которая с 2025 года строит модульные дома из металлокаркаса. Мы прошли путь от мастерской до собственного производства полного цикла.
            </p>
